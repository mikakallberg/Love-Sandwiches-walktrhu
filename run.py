...
def validate_data(values):
    """
    Inside the try, converts all strind values into integers.
    Raises ValueError if string cannot be converted into in,
...
def get_latest_5_entries_sales():
    """
...
sales_columns = get_latest_5_entries_sales()